            ...
            steps {
                script {
                    catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                        ...
                        git url: 'https://github.com/DevaNandaRadhakrishnan/SpringSecurity.git', branch: 'main'
                    }
                }
            }
        }
            ...
            steps {
                script {
                    catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                        ...
                        docker run -d --network my-network -p 8090:8090 --name authentication-sr authentication-sr:latest
                        '''
                    }
                }
            }
